...
TEST_MASK_TYPES = ["roads-5px", "roads-1px", "roads-28px"]		# ground truth used to compute metrics (to compare with AMREL) : 
...
#TEST_MASK_TYPES = ["amrel-processed", "amrel-1px", "amrel-28px"]	#to compare with different CNN architectures
